...
sp<AudioFlinger::EffectModule> AudioFlinger::ThreadBase::getEffect(int sessionId,
        int effectId)
{
    Mutex::Autolock _l(mLock);
            ...
            if (mSleepTimeUs == 0) {
                ...
                if (mType == MIXER && !mStandby) {
                    ...
                    if (mThreadThrottle
                        ...
                        // 2. threadLoop_mix (significant for heavy mixing especially on slow processor)
