...
AudioFlinger::DirectAudioTrack::~DirectAudioTrack() {
    ...
    AudioSystem::releaseOutput(mOutput, (audio_stream_type_t)mOutputDesc->mStreamType, (audio_session_t)NULL);
    releaseWakeLock();
...
status_t AudioFlinger::DirectAudioTrack::start() {
    AudioSystem::startOutput(mOutput, (audio_stream_type_t)mOutputDesc->mStreamType, (audio_session_t)NULL);
    if(mIsPaused) {
        mIsPaused = false;
...
void AudioFlinger::DirectAudioTrack::stop() {
    ...
    AudioSystem::stopOutput(mOutput, (audio_stream_type_t)mOutputDesc->mStreamType, (audio_session_t)NULL);
}
