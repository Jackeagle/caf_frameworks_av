...
class PostProcNativeWindow
    : public ANativeObjectBase<ANativeWindow, PostProcNativeWindow, RefBase>
{
...
private:
    ...
    ANativeWindowBuffer* getFreeBuffer(bool postProc);
    void pushBufferToFreeList(ANativeWindowBuffer *buf, bool postProc);
