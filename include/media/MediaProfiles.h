...
enum camcorder_quality {
    ...
    CAMCORDER_QUALITY_QHD = 20,
    CAMCORDER_QUALITY_2k = 21,
    CAMCORDER_QUALITY_LIST_END = 21,
    ...
    CAMCORDER_QUALITY_TIME_LAPSE_QHD = 1020,
    CAMCORDER_QUALITY_TIME_LAPSE_2k = 1021,
    CAMCORDER_QUALITY_TIME_LAPSE_LIST_END = 1021,
